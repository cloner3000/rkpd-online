    ...
    <div class="row form-group">
        <div class="col-md-6">
            <div class="form-group m-form__group {{ $errors->has('tahun') ? 'has-danger' : ''}}">
                ...
                <input type="hidden" name="tahun" value="{{ $item->tahun ?? (Carbon\Carbon::now()->year)  }}">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group m-form__group {{ $errors->has('sumber_anggaran') ? 'has-danger' : '' }}">
                ...
                <select class="form-control m-select2" id="m_select2_1" disabled>
                    <option value="{{ $sumberAnggaranPuguIndikatif->id  }}" disabled
                            selected>{{ $sumberAnggaranPuguIndikatif->nama }}</option>
                </select>
...
@include('dewan.musrenbang._lokasi')
