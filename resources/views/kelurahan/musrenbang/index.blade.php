...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">Musrenbang Kelurahan</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('musrenbang-kelurahan.index') }}" class="m-nav__link">
                            <span class="m-nav__link-text">Musrenbang Kelurahan</span>
                        </a>
                    </li>
            </div>
        </div>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Hasil Musrenbang Kelurahan</h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="form-group m-form__group row align-items-center">
                                <div class="col-md-7">
                                    @include('global.table_search', [
                                       'action' => route('musrenbang-kelurahan.index', ['url'=>'items']),
                                       'search' => $search ?? ""
                                   ])
                                </div>
                            </div>
                        ...
                        @if ($canEntry)
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                <a href="{{ route('musrenbang-kelurahan.create') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    @include('global.table_action', [
                                        'action' => route('musrenbang-kelurahan.destroy', ['id' => $item->id]),
                                        'url'    => route('musrenbang-kelurahan.edit', ['id' => $item->id]),
                                        'id'     => $item->id,
                                        'show'   => route('musrenbang-kelurahan.show', $item->id),
                                        'transfer' => route('musrenbang-kelurahan.transfer', ['id' => $item->id]),
                                    ])
                                </td>
                            </tr>
                        @empty
