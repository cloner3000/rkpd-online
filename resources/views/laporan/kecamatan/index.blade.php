                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('musrenbang-kecamatan.index') }}" class="m-nav__link">
                            <span class="m-nav__link-text">{{ $title ?? 'Laporan' }} Musrenbang Kecamatan</span>
                        </a>
                    </li>
            </div>
        </div>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">{{ $title ?? 'Laporan' }} Musrenbang Kecamatan</h3>
                    </div>
                </div>
            </div>
            <div class="m-portlet__body">
                ...
                <form action="{{ route('laporan.kecamatan.preview') }}" method="post">
                    {{ csrf_field() }}
