...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">Rancangan kerja</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('kerja.index') }}" class="m-nav__link">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('kerja.index') }}" class="m-nav__link">
                            <span class="m-nav__link-text">Rancangan kerja</span>
                        </a>
                    </li>
            </div>
        </div>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Hasil Rancangan kerja</h3>
                    </div>
                </div>
            </div>
                        ...
                        <a href="{{ route('kerja.create') }}"
                           class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            <span><i class="la la-plus"></i>
                                <span>Tambah Rancangan kerja</span>
                            </span>
                        </a>
