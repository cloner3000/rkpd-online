            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Daftar Kegiatan</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="{{ route('kegiatan.create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                        ...
                        <tr>
                            ...
                            <td>
                                @include('global.table_action_admin', [
                                    ...
                                    'url'    => route('kegiatan.edit', ['id' => $item->id]),
                                    'id'     => $item->id,
                                    'show'   => route('kegiatan.indikator-kegiatan.index', $item->id)
                                ])
                            </td>
                        </tr>
                    @endforeach
