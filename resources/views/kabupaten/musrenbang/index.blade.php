            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Hasil Musrenbang Kabupaten</h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-group m-form__group row align-items-center">
                                <div class="col-md-7">
                                    @include('global.table_search', [
                                       'action' => route('musrenbang-kabupaten.index', ['url'=>'items']),
                                       'search' => $search ?? ""
                                   ])
                                </div>
                            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                @include('global.table_action', [
                                    'action' => route('musrenbang-kabupaten.destroy', ['id' => $item->id]),
                                    'url'    => route('musrenbang-kabupaten.edit', ['id' => $item->id]),
                                    'id'     => $item->id,
                                    'show'   => route('musrenbang-kabupaten.show', $item->id),
                                    'transfer' => route('musrenbang-kabupaten.transfer', ['id' => $item->id]),
                                ])
                            </td>
                        </tr>
                        @empty
