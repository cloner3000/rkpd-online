        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('kuappas.index') }}" class="m-nav__link">
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Hasil KUA PPAS</h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-group m-form__group row align-items-center">
                                <div class="col-md-7">
                                    @include('global.table_search', [
                                       'action' => route('kuappas.index', ['url'=>'items']),
                                       'search' => $search ?? ""
                                   ])
                                </div>
                            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                @include('global.table_action', [
                                    'action' => route('kuappas.destroy', ['id' => $item->id]),
                                    'url'    => route('kuappas.edit', ['id' => $item->id]),
                                    'id'     => $item->id,
                                    'show'   => route('kuappas.show', $item->id),
                                    'transfer' => route('kuappas.transfer', ['id' => $item->id]),
                                ])
                            </td>
                        </tr>
                        @empty
