...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">KUA PPAS</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('akhir.index') }}" class="m-nav__link">
                    ...
                    <li class="m-nav__item">
                        <a href="#" class="m-nav__link">
                            <span class="m-nav__link-text">KUA PPAS</span>
                        </a>
                    </li>
            </div>
        </div>
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Detail KUA PPAS</h3>
                    </div>
                </div>
            </div>
            <div class="m-portlet__body">
                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    ...
                    <div class="m-portlet__body" style="padding-top:0px">
                                    ...
                                    @if(if_route_pattern(['musrenbang-desa.*', 'musrenbang-kelurahan.*']))
                                        ...
                                        <select class="form-control m-select2" id="m_select2_1" name="sumber_anggaran" required disabled>
                                            @foreach ($sumberAnggarans as $anggaran)
                                                <option value="{{ $anggaran->id  }}" {{ $item->sumberAnggaran->id == $anggaran->id ? 'selected' : '' }} >{{ $anggaran->nama }}</option>
                                            @endforeach
                                        </select>
                                        <input type="hidden" name="sumber_anggaran" value="{{ $sumberAnggaranPuguIndikatif->id }}">
                                    @else
                                        <label>
                                            Sumber Anggaran
                                        </label>
                        ...
                        <div class="form-group m-form__group {{ $errors->has('nama_kegiatan') ? ' has-danger ' : '' }} ">
                            ...
                            <input type="text" class="form-control m-form" value="{{ $item->kegiatan->nama }}" disabled readonly>
                        </div>
                ...
                <strong>{{ $errors->first('nama_kegiatan') }}</strong>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="number" step="any"
                                                       name="target_indikator_kegiatan[{{ $target->indikatorKegiatan->id }}]" disabled
                                                       class="form-control m-input"
                    ...
                    <div class="form-group m-form__group">
                        <label>Pagu</label>
                        <input type="text" name="pagu_usulan" class="form-control m-input"
                           value="{{ $item->pagu }}" disabled 
                           >
                    </div>
