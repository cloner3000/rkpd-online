...
namespace App\Http\Controllers\laporan\kabupaten;
...
class LaporanController extends Controller
{
    ...
    public function __construct(DashboardService $dashboard_service)
    {
        ...
        $this->tahapan = Tahapan::whereNama(\App\Enum\Tahapan::KABUPATEN)->first();
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('laporan.kabupaten.index', compact('village',
            'villages',
            'district',
            'districts',
            'users'));
...
//        dd($request->all());
        ...
        return view('laporan.kabupaten.preview', compact('items', 'district', 'village', 'user'));
    }
    ...
    public function show(Request $request)
    {
        ...
        $items = $items->toJson();
        $view_table = view('laporan.kabupaten._table', compact('items', 'anggaran', 'program','kegiatan','sasaran','indikatorsasaran', 'sumberanggaran', 'urusan'));
    ...
    public function exportExcel(Request $request)
    {
        ...
        $writer->openToBrowser('Laporan Rancangan Kabupaten.xlsx'); // stream data directly to the browser
