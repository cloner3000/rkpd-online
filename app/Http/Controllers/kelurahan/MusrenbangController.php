...
class MusrenbangController extends Controller
{
    ...
    {
        $this->middleware('kelurahan', ['only' => ['create', 'update', 'destroy']]);
    ...
    public function index(Request $request)
    {
        ...
        $canManage = $user->hasRole(Roles::KELURAHAN);
        ...
        $items = Anggaran::TahapanAndIsKelurahan(\App\Enum\Tahapan::DESA, true);
        ...
        return view('kelurahan.musrenbang.index', compact('items', 'canEntry', 'canManage', 'search', 'canTransfer'));
    }
    ...
    public function create()
    {
        ...
        return view('kelurahan.musrenbang.create', compact(
            'districts',
            'visi',
            'opds',
            'jenisLokasi',
    ...
    public function store(Request $request)
    {
        ...
        $this->musrenbang_service->store($request, $tahapan, true);
    ...
    public function show($id)
    {
        ...
        $sumberAnggarans = SumberAnggaran::all();
        $sumberAnggaranPuguIndikatif = SumberAnggaran::whereNama('Pagu Indikatif')->first();
        return view('kelurahan.musrenbang.show', compact(
            'item',
            'districts',
            'visi',
            'jenisLokasi',
    ...
    public function edit($id)
    {
        ...
        $sumberAnggarans = SumberAnggaran::all();
        $sumberAnggaranPuguIndikatif = SumberAnggaran::whereNama('Pagu Indikatif')->first();
        return view('kelurahan.musrenbang.edit', compact(
            'item',
            'districts',
            'visi',
            'jenisLokasi',
