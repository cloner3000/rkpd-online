...
namespace App\Http\Controllers\akhir;
...
class RancanganController extends Controller
{
    ...
    {
        $this->middleware('opd')->only('edit', 'update', 'destroy', 'transfer');
        $this->musrenbang_service = $musrenbang_service;
        $this->tahapan = \App\Enum\Tahapan::RANCANGAN_AKHIR;
    }
    ...
    public function index(Request $request)
    {
        ...
        $canManage = false;
        $canTransfer = can_transfer('Rancangan KUA PPAS');
        $user = auth()->user();
        ...
        return view('rancangan.akhir.index', compact(
            'items',
            'canEntry',
            'user',
            'canTransfer',
    ...
    public function show($id)
    {
        ...
        $sumberAnggarans = SumberAnggaran::all();
        $sumberAnggaranPuguIndikatif = SumberAnggaran::whereNama('Pagu Indikatif')->first();
        return view('rancangan.akhir.show', compact(
            'item',
            'districts',
            'visi',
            'jenisLokasi',
    ...
    public function edit(Request $request, $id)
    {
        ...
        $sumberAnggarans = SumberAnggaran::all();
        $sumberAnggaranPuguIndikatif = SumberAnggaran::whereNama('Pagu Indikatif')->first();
        return view('rancangan.akhir.edit', compact(
            'item',
            'districts',
            'visi',
            'jenisLokasi',
